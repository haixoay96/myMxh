...
const Tab = (props) => {
    let listIcon = ['window-maximize', 'user-plus', 'globe', 'bars'];
...
class TabViewSwiper extends React.Component {
    ...
    render() {
        return (
            <View>
                <View>
                    <Swiper ref='swiper'  height={height - 100 - heightStatusBar} showsPagination={true} loop={false} onMomentumScrollEnd={this.onMomentumScrollEnd}>
                        <TabNews/>
                        <TabNews/>
                        <TabNews/>
                        <TabNews/>
